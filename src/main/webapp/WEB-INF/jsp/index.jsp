...
<head>
    ...
    <![endif]-->
    <title>北理商城后台管理系统 v1.1</title>
    <meta name="keywords" content="北理商城后台管理系统 v1.1,北理商城,北理商城购物商城后台管理系统">
    <meta name="description" content="北理商城后台管理系统 v1.1，是一款电商后台管理系统，适合中小型CMS后台系统。">
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">北理商城后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">北理商城后台管理系统</a>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                       ...
                       <%-- <li ><a href="http://xpay.exrick.cn" target="_blank">XPay支付系统</a></li>--%>
                        <li ><a href="http://bithelper.site" target="_blank">商城前台</a></li>
                    </li>
                </ul>
            </nav>
