...
<div data-vide-bg="lib/video/Ipad">
    <div class="center-container">
        ...
        <div class="header-w3l">
            <h1>北理商城<span class="title">后台管理系统</span></h1>
        </div>
        <!--//header-->
        ...
        <!--footer-->
        <div class="footer">
            <p>&copy; 2019 北理商城. All rights reserved | Design by <a href="https://limengting.site" target="_blank">Sunnie</a></p>
        </div>
        <!--//footer-->
    </div>
</div>
