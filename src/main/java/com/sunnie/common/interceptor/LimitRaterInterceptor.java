package com.sunnie.common.interceptor;

import cn.hutool.core.util.StrUtil;
import com.sunnie.common.annotation.RateLimiter;
import com.sunnie.common.constant.CommonConstant;
import com.sunnie.common.exception.XmallException;
import com.sunnie.common.limit.RedisRaterLimiter;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (rateLimitEnable) {
            ...
            if (StrUtil.isBlank(token2)) {
                throw new XmallException("当前访问总人数过多，请稍后再试");
            }
        }
        ...
        if (rateLimiter != null) {
            ...
            if (StrUtil.isBlank(token3)) {
                throw new XmallException("当前访问人数太多，请稍后再试");
            }
        }
        return true;
    }
