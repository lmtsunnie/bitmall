...
import com.sunnie.pojo.front.CommonDto;
import com.sunnie.pojo.front.GeetInit;
import com.sunnie.pojo.front.Member;
import com.sunnie.pojo.front.MemberLoginRegist;
import com.sunnie.service.LoginService;
import com.sunnie.service.MemberFrontService;
import com.sunnie.service.RegisterService;
import com.sunnie.utils.GeetestLib;
...
public class MemberFrontController {
    ...
    public Result<Object> imgaeUpload(@RequestBody CommonDto common,
        ...
        if (StringUtils.isNotBlank(temp)) {
            return new ResultUtil<Object>().setErrorMsg("您上传的太频繁啦，请10秒后再试");
        }
