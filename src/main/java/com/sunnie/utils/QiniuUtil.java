package com.sunnie.utils;

import com.sunnie.common.exception.XmallUploadException;
...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "4Uk12cIO6mqC3QR0DapG349IFjP5bA_bMwIl0mcj";
    private static String secretKey = "6-R9_xaEnpkR34WZf8HTTsKCJ2o8cnUk1ZJZYlnO";
    private static String bucket = "bithelper";
    private static String origin = "http://qiniu.sunnie.xyz/";
    private static Auth auth = Auth.create(accessKey, secretKey);

    public static String qiniuUpload(String filePath) {

        //构造一个带指定Zone对象的配置类 zone1华北
    ...
    public static String qiniuBase64Upload(String data64) {
        ...
        String url = "http://up-z1.qiniup.com/putb64/-1/key/" + UrlSafeBase64.encodeToString(key);
