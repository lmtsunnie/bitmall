...
import com.sunnie.pojo.dto.EsCount;
import com.sunnie.pojo.dto.EsInfo;
import com.sunnie.pojo.front.SearchItem;
import com.sunnie.service.SearchItemService;
import com.sunnie.utils.HttpUtil;
...
public class SearchItemServiceImpl implements SearchItemService {
    ...
    @Value("${ES_USER_PASSWORD}")
    private String ES_USER_PASSWORD;
    ...
    public int importAllItems() {
        ...
        try {
            Settings settings = Settings.builder()
                    ...
                    .put("xpack.security.user", "\"" + ES_USER_NAME + ":" + ES_USER_PASSWORD + "\"")
                    .build();
